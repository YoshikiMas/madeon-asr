...
from espnet2.asr.state_spaces.mamba.mamba import Block
from espnet2.asr.state_spaces.mamba.mamba2 import Mamba2
try:
...
class Mamba2EncoderLayer(torch.nn.Module):
    """Mamba2 encoder layer module."""
    ...
    def __init__(
        ...
        if ssm_cfg is None:
            ssm_cfg = {}
        factory_kwargs = {"device": device, "dtype": dtype}
        self.mixer_cls = partial(Mamba2, layer_idx=layer_idx, **ssm_cfg, **factory_kwargs)
...
class SerialBiMamba2EncoderLayer(Mamba2EncoderLayer):
    def __init__(
        self,
        d_model: int,
        ssm_cfg=None,
...
class Mamba2Encoder(AbsEncoder):
    ...
    def __init__(
        ...
        self.encoders = repeat(
            num_blocks,
            lambda lnum: Mamba2EncoderLayer(
                output_size,
                ssm_cfg=ssm_cfg,
