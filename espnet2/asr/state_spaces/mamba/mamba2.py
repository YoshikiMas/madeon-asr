...
try:
    from espnet2.asr.state_spaces.ops.triton.selective_state_update import selective_state_update
except ImportError:
    selective_state_update = None

from espnet2.asr.state_spaces.ops.triton.layernorm_gated import RMSNorm as RMSNormGated

from espnet2.asr.state_spaces.distributed.tensor_parallel import ColumnParallelLinear, RowParallelLinear
from espnet2.asr.state_spaces.distributed.distributed_utils import all_reduce, reduce_scatter

from espnet2.asr.state_spaces.ops.triton.ssd_combined import mamba_chunk_scan_combined
from espnet2.asr.state_spaces.ops.triton.ssd_combined import mamba_split_conv1d_scan_combined

from espnet2.asr.state_spaces.s4 import OptimModule

class Mamba2(OptimModule):
    def __init__(
        self,
        d_model,
        d_state=128,
